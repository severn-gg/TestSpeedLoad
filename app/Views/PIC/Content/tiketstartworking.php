            ...
            <div class="col-12">
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row no-print">
                        <div class="col-12">
                            <a href="<?= base_url('pic/tiketstartworkingprint') ?>" rel="noopener" target="_blank"
                                class="btn btn-primary">
                                <i class="fas fa-print"></i> Print
                            </a>
                            <a href="#" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addModal"><i
                                    class="bi bi-hammer"></i> Perbaiki Case Ini</a>
        ...
        <form action="#" method="post" enctype="multipart/form-data" wire:submit.prevent="savePersonalData"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <h5 class="bg-danger">Tandai Tiket Ini sebagai - Sedang Diperbaiki / On Progress</h5>
                    </div>
                </div>
