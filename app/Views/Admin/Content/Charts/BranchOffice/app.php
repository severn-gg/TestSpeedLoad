...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Laporan Branch Office</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item">Charts</li>
                    <li class="breadcrumb-item active">Laporan by Branch Office</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="modal fade" id="tiketModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <form action="<?= base_url('admin/laporanbo/ByStatus') ?>" id="formExportBOByStatus">
...
<div class="modal fade" id="kategoriModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <form action="<?= base_url('admin/laporanbo/ByKategori') ?>" id="formExportBOByKategori">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#123670; color:white;">
...
<div class="modal fade" id="departemenModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <form action="<?= base_url('admin/laporanbo/ByVerifikator') ?>">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#123670; color:white;">
