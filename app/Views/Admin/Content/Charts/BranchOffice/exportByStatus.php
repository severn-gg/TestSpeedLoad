...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Export BO Report by Status Tiket</h1>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Export by Status Tiket</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
                ...
                <div class="invoice p-3 mb-3">
                    ...
                    <div class="row">
                        <div class="col-12 table-responsive">
                            <p class="lead">Tiket by Status</p>
                            <table id="tabelExportChartBOByStatus" class="table table-striped">
                                <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Branch Office</th>
