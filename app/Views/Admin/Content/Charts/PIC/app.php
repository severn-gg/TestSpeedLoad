...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Laporan PIC</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item">Charts</li>
                    <li class="breadcrumb-item active">Laporan PIC</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <a class="btn bg-primary" href="#" data-bs-toggle="modal" data-bs-target="#tiketModal">
                        <i class="bx bxs-tag"></i> Solving Tiket
                    </a>
...
<div class="modal fade" id="tiketModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <form action="<?= base_url('admin/laporanpic/BySolvingTiket') ?>" id="formExportTiketByStatus">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#123670; color:white;">
                    <h5 class="modal-title">Export By Solving Tiket</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-4 col-form-label">Select PIC</label>
                        <div class="col-sm-8">
                            <select class="form-control form-control" aria-label="Default select example"
                                name="selectPIC">
                                <option value="1">Semua PIC</option>
                                <option value="2">Andi</option>
                                <option value="3">Indra</option>
                                <option value="4">Hendro</option>
                                <option value="5">Riyo</option>
                            </select>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="kategoriModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <form action="<?= base_url('admin/laporanpic/ByKategoriTiket') ?>" id="formExportTiketByKategori">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#123670; color:white;">
...
<div class="modal fade" id="kantorModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-scrollable">
        <form action="<?= base_url('admin/laporanpic/ByKantorTiket') ?>" id="formExportTiketByKantor">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#123670; color:white;">
